...
SELECT * 
FROM world_layoffs.layoffs_staging2;   -- layoffs_staging2-our cleaned data  table
...
-- Which companies had 1 which is basically 100 percent of company laid off
SELECT *
FROM world_layoffs.layoffs_staging2
...
-- BritishVolt looks like an EV company, Quibi! - wow raised like 2 billion dollars and went under - ohh!!
